...
// Get this from http://yujianrong.bitbucket.org/JsTool/iPadMangaReader/Reader.js
// Make change to support dm9
...
($___=function()
{
    ...
    var parseEngine={
        ...
        ,"comic.131.com/content/":function()
        {
            ...
            getImgURL=function(thePage)
            {
                ...
                request.send();
                // request.responseText;
                var reScript =/<script.*?id="imgjs".*?src=".*?img=(.*?)"/; 
                var reImg =/<img.*?id="comicBigPic".*?src="(.*?)"/; 
                if ( reScript.test( request.responseText ) ) {
                  return reScript.exec( request.responseText )[1];
                } else {
                  return reImg.exec(request.responseText)[1]
                }
            };
            setCurrentPage=function(thePage)
            {
        ...
        ,"www.kkkmh.com/manhua":function(){
            ...
            Array.prototype.forEach.call($("chapter-func").getElementsByTagName("a"), function(aElement) {
                if (aElement.text === "ä¸‹ä¸€ç« ") {
                  chapters.next = {
                    text: aElement.title,
                    href: aElement.href
                  };
                } else if (aElement.text === "ä¸Šä¸€ç« ") {
                  chapters.pre = {
                    text: aElement.title,
                    href: aElement.href
                  }
    ...
    var loc_RELOAD="é‡æ–°è½½å…¥",
        loc_VERTICALWRITTING="ä»Žå³å‘å·¦é˜…è¯»",
        loc_CURRENTPAGE="å½“å‰é¡µï¼š",
        loc_JUMPTOPAGE="è·³è½¬åˆ°ï¼š",
        loc_FIRSTPAGE="å·²ç»æ˜¯ç¬¬ä¸€é¡µäº†",
        loc_LASTPAGE="å·²ç»æ˜¯æœ€åŽä¸€é¡µäº†",
        loc_NOPARSER="ä¸èƒ½å¤„ç†è¯¥é¡µé¢ï¼Œé˜…è¯»å™¨ä»…èƒ½å¤„ç†ä»¥ä¸‹é¡µé¢ï¼š\n%s",
        loc_NEXTCHAPTER="ä¸‹ä¸€ç« :<br/>%s",
        loc_PREVCHAPTER="ä¸Šä¸€ç« :<br/>%s",
        loc_NONEXTCHAPTER="æ²¡æœ‰ä¸‹ä¸€ç« èŠ‚",
        loc_NOPREVCHAPTER="æ²¡æœ‰ä¸Šä¸€ç« èŠ‚",
        loc_LANDSCAPEWARNING="æœ¬é¡µé¢ä»…èƒ½åœ¨æ¨ªå‘æ¨¡å¼é˜…è¯»ï¼Œè¯·æ—‹è½¬æ‚¨çš„è®¾å¤‡ï¼",
        loc_PORTRAITWARNING="æœ¬é¡µé¢ä»…èƒ½åœ¨çºµå‘æ¨¡å¼é˜…è¯»ï¼Œè¯·æ—‹è½¬æ‚¨çš„è®¾å¤‡ï¼",
        loc_ANIMATIONENABLE="å¹³æ»‘ç¿»é¡µ",
        loc_ANIMATIONWARNING="æ³¨æ„ï¼šå¹³æ»‘ç¿»é¡µå¯èƒ½ä¼šé€ æˆæ‚¨çš„Safariæµè§ˆå™¨å´©æºƒï¼\næ‚¨ç¡®å®šè¦æ‰“å¼€å¹³æ»‘ç¿»é¡µåŠŸèƒ½å—ï¼Ÿ",
        loc_LOADING="è½½å…¥ä¸­â€¦â€¦é•¿æ—¶é—´æ— ååº”è¯·åˆ·æ–°é¡µé¢é‡è¯•",
        loc_PRELOADPAGENUM = "å‘åŽé¢„è½½å…¥é¡µæ•°ï¼š";
